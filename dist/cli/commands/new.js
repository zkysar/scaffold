    ...
    if (options.template) {
        ...
        try {
            ...
            if (library.templates.length === 0) {
                ...
                console.log(chalk_1.default.gray('Or specify a template with: scaffold new my-project --template <template-name>'));
                return;
            }
            if (verbose) {
                console.log(chalk_1.default.blue('Found'), library.templates.length, 'available templates');
            }
            ...
            if (verbose) {
                console.log(chalk_1.default.blue('Selected templates:'), templateIds);
            }
        }
        catch (error) {
