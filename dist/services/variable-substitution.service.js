...
exports.VariableSubstitutionService = void 0;
...
class VariableSubstitutionService {
    ...
    substituteVariables(content, variables, options = {}) {
        const opts = {
    ...
    async substituteInFile(filePath, variables, options = {}) {
        try {
    ...
    substituteInPath(path, variables, options = {}) {
        return this.substituteVariables(path, variables, options);
    }
    validateRequiredVariables(template, provided) {
        const errors = [];
    ...
    createContext(variables) {
        ...
        return {
            ...
            transforms: {
                ...
                'camelCase': (value) => this.toCamelCase(value),
                'kebabCase': (value) => this.toKebabCase(value),
                'snakeCase': (value) => this.toSnakeCase(value),
                'pascalCase': (value) => this.toPascalCase(value),
                'capitalize': (value) => value.charAt(0).toUpperCase() + value.slice(1).toLowerCase(),
                'trim': (value) => value.trim(),
            }
        };
    }
    performSubstitution(content, context, processedVars, options) {
    ...
    processVariable(variable, context, processedVars, options) {
    ...
    resolveVariableValue(varName, variables) {
...
exports.VariableSubstitutionService = VariableSubstitutionService;
//# sourceMappingURL=variable-substitution.service.js.map